...
class HiraganaAndKatakana_RandMult_Activity : AppCompatActivity()
{
    ...
    // Because "bothCharacterSets" has its contents being removed using "removeAt[currentCharacter]", it is being re-indexed
    // The re-indexing breaks the attachment between the value at "bothCharacterSets[currentCharacter]" and the answer associated with
    // it at "allRanjiCharactersDuplicated[currentCharacter]"
    // Therefore, the solution is to have "allRanjiCharactersDuplicated" get re-indexed as well
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hiragana_and_katakana_rand_mult)
        ...
        val correctScore: TextView = findViewById(R.id.HiraganaAndKatakanaRandMultDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.HiraganaAndKatakanaRandMultDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun readFiles()
    {
        ...
        try {
            ...
            allRanjiCharactersHolder = sendToList(Ranji_Chars)
    ...
    private fun assignAnswers()
    {
        ...
        var buttonCopy: Button = findViewById(R.id.HiraganaAndKatakanaRandMultButtonTopLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaAndKatakanaRandMultButtonTopRight)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaAndKatakanaRandMultButtonBottomLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaAndKatakanaRandMultButtonBottomRight)
        buttons.add(buttonCopy)
        ...
        var labelCopy: TextView = findViewById(R.id.HiraganaAndKatakanaRandMultDisplayChar)
