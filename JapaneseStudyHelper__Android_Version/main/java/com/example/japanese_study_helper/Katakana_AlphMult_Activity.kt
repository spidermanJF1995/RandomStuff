...
class Katakana_AlphMult_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_katakana_alph_mult)
        ...
        val correctScore: TextView = findViewById(R.id.KatakanaAlphMultDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.KatakanaAlphMultDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun assignAnswers()
    {
        ...
        var buttonCopy: Button = findViewById(R.id.KatakanaAlphMultButtonTopLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.KatakanaAlphMultButtonTopRight)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.KatakanaAlphMultButtonBottomLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.KatakanaAlphMultButtonBottomRight)
        buttons.add(buttonCopy)
        ...
        var labelCopy: TextView = findViewById(R.id.KatakanaAlphMultDisplayChar)
        ...
        buttons.forEach{
            ...
            do
            {
                randomCharacter = Random.nextInt(0, allKatakanaCharacters.size)
            }
...
} // end Katakana_AlphMult_Activity