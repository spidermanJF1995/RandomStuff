...
class Katakana_RandFree_Activity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_katakana_rand_free)
        ...
        val EditTextCopy: EditText = findViewById(R.id.KatakanaRandFreeEnterAnswer)
        ...
        val correctScore: TextView = findViewById(R.id.KatakanaRandFreeDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.KatakanaRandFreeDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun assignAnswers()
    {
        ...
        var userAnswer : EditText = findViewById(R.id.KatakanaRandFreeEnterAnswer)
        userAnswer.setText("")
        ...
        var labelCopy: TextView = findViewById(R.id.KatakanaRandFreeDisplayChar)
...
} // end Katakana_RandFree_Activity