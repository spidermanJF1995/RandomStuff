...
class Katakana_AlphFree_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_katakana_alph_free)
        ...
        val EditTextCopy: EditText = findViewById(R.id.KatakanaAlphFreeEnterAnswer)
        ...
        val correctScore: TextView = findViewById(R.id.KatakanaAlphFreeDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.KatakanaAlphFreeDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun assignAnswers()
    {
        ...
        var userAnswer : EditText = findViewById(R.id.KatakanaAlphFreeEnterAnswer)
        userAnswer.setText("")
        ...
        var labelCopy: TextView = findViewById(R.id.KatakanaAlphFreeDisplayChar)
...
} // end Katakana_AlphFree_Activity