...
class Hiragana_RandMult_Activity : AppCompatActivity()
{
    ...
    // Because "allHiraganaCharacters" has its contents being removed using "removeAt[currentCharacter]", it is being re-indexed
    // The re-indexing breaks the attachment between the value at "allHiraganaCharacters[currentCharacter]" and the answer associated with
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hiragana_rand_mult)
        ...
        val correctScore: TextView = findViewById(R.id.HiraganaRandMultDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.HiraganaRandMultDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun assignAnswers()
    {
        ...
        var buttonCopy: Button = findViewById(R.id.HiraganaRandMultButtonTopLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaRandMultButtonTopRight)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaRandMultButtonBottomLeft)
        buttons.add(buttonCopy)

        buttonCopy = findViewById(R.id.HiraganaRandMultButtonBottomRight)
        buttons.add(buttonCopy)

        // Gets a random character...
        currentCharacter = Random.nextInt(0, allHiraganaCharacters.size)
        ...
        allHiraganaCharacters.removeAt(currentCharacter)
        ...
        var labelCopy: TextView = findViewById(R.id.HiraganaRandMultDisplayChar)
...
} // end Hiragana_RandMult_Activity