...
class Hiragana_RandFree_Activity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hiragana_rand_free)
        ...
        val EditTextCopy: EditText = findViewById(R.id.HiraganaRandFreeEnterAnswer)
        ...
        val correctScore: TextView = findViewById(R.id.HiraganaRandFreeDisplayCorrectNumberValue)
        val wrongScore: TextView = findViewById(R.id.HiraganaRandFreeDisplayWrongNumberValue)
        correctScore.text = "0"
        wrongScore.text = "0"
    ...
    private fun assignAnswers()
    {
        ...
        var userAnswer : EditText = findViewById(R.id.HiraganaRandFreeEnterAnswer)
        userAnswer.setText("")
        ...
        var labelCopy: TextView = findViewById(R.id.HiraganaRandFreeDisplayChar)
